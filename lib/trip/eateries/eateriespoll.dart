...
class EateriesVotingPage extends StatefulWidget {
  @override
  _EateriesVotingPageState createState() => _EateriesVotingPageState();
}

class _EateriesVotingPageState extends State<EateriesVotingPage> {
