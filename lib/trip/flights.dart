...
class SectionPage2 extends StatefulWidget {
  @override
  _SectionPage2State createState() => _SectionPage2State();
}

class _SectionPage2State extends State<SectionPage2>
          ...
          return Scaffold(
            ...
            appBar: AppBar(
                ...
                children: [
                  ...
                  DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 43, 16, 162),),
              ...
              bottom: TabBar(
                ...
                labelColor: Color.fromARGB(255, 43, 16, 162),
                indicatorColor: Color.fromARGB(255, 43, 16, 162),
              ),
            ),
            body: Stack(
              children: [
                TabBarView(
                  children: [
                    _buildContent(title: 'Flights'),
                    _buildContent(title: 'Stays'),
                    _buildContent(title: 'Eateries'),
                    _buildContent(title: 'Activities'),
                  ],
                ),
                Visibility(
                  ...
                  child: Positioned(
                    ...
                    child: FloatingActionButton(
                      ...
                      backgroundColor: Color.fromARGB(255, 43, 16, 162),
                    ),
                  ),
                ),
                Visibility(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Text('Add participants',
                          style: TextStyle(color: Color.fromARGB(255, 43, 16, 162), fontFamily: 'Dosis', fontSize: 18, fontWeight: FontWeight.w600)),
                      onTap: () {
        ...
        Container(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              primary: Color.fromARGB(255, 43, 16, 162), // Change the button color
  ...
  Widget _buildContent({required String title}) {
    return ListView(
